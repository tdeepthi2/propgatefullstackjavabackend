...
import com.example.propgate.services.InvestmentService;
...
public class InvestmentController {
    ...
    public Investment saveData(@RequestBody Investment data) {
    ...
    public ResponseEntity<?> get(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.status(404).body("Investment not found");
        }
    }

    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody Investment data) {
        try {
